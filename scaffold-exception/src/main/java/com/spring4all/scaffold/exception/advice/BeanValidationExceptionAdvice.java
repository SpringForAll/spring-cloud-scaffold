...
public class BeanValidationExceptionAdvice {
    ...
    public BaseResult<Map<String, String>> methodArgumentNotValidException(MethodArgumentNotValidException exception) {
        ...
        return new BaseResult<>(BaseResult.ERROR_TYPE, BaseErrorCode.PARAMTER_ILLEGAL.getCode(), BaseErrorCode.PARAMTER_ILLEGAL.getMsg(), errorMap);
    }

    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ExceptionHandler(ConstraintViolationException.class)
    public BaseResult<Map<String, String>> constraintViolationException(ConstraintViolationException exception) {
        Map<String, String> errorMap = new HashMap<>();
